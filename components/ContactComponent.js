...
// these are the state properties
    ...
    //this sets the props based on the targets name 
...
//this handles changes in form elements with 2 var's
handleInputChange(event){
    const target = event.target;
    const name = target.name;
    //this is a ternary operation it could be first name last name or email ect
